...
if __name__ == "__main__":
    setup(
        ...
        version=__version__,
        author = "3DiVi team",
        author_email = "sergey@divi.com",
        description="Package allows you to use 3DiVi Open Source Face SDK in python language",
        url = "https://github.com/3DiVi/Open-Source-Face-SDK",
